...
用于将已有 H5 游戏导入网易星匣。调用平台工具前读 [上游工具](upstream-tools.md)，按当前官方 Skill/CLI 完成接入。
...
2026-09-22记录的后台要求：封面 JPG/PNG、≤5 MB；800×450为推荐。名称2–30字符、简介≤300、分类1–2、标签1–5；关于≤1000个Markdown源码字符、操作说明≤500均选填。宣传图/视频选填，合计最多8个：图片JPG/PNG/WebP≤5 MB；视频MP4/WebM/OGG≤100 MB且≤60秒；1024×556为推荐。导入 H5 按已有游戏入口处理，文案与标签使用当前游戏资料。见[字段映射](listing-fields.md)与[包体超限流程](package-budget.md)。
