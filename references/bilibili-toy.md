...
Use this profile to package static H5 content for Bilibili TOY. Follow [upstream tools](upstream-tools.md) to use the current official `bilibili/toy` Skill and CLI.
